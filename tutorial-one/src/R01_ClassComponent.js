/* JS파일과 JAVA 파일을 외부에서 사용할 때는 무조건 대문자로 시작
 ...
 R01_ClassComponent 작성하면 외부에서 사용할 수 있음
*/
import React, {Component} from "react";
// -> node-modules 폴더에서 react 라는 폴더에 있는 파일을 가져와서
...
//만든 class export default를 지정해야만 외부에서 사용 가능
...
// Component를 상속받는 하위 클래스에 반드시 있어야하는 함수       
        return (
            ...
            <pre>
                ...
                <></> = 커스텀태그 / html 표준에 없는 사용자 정의 태그 특정 기능이나 화면 감싸는데 사용
            </pre>
